...
const Header = () => {
  ...
  return (
    <div className='pb-5 pt-2 bg-[linear-gradient(#ee4d2d,#ff7337)] text-white'>
            ...
            renderPopover={
              <div className='relative bg-white border border-gray-200 rounded-sm shadow-md'>
                <div className='flex flex-col py-2'>
                  <button className='py-2 pl-3 pr-32 hover:text-orange'>Tiếng việt</button>
                  <button className='py-2 pr-32 hover:text-orange'>English</button>
                </div>
              </div>
            }
          >
            ...
            >
              <div className='flex-shrink-0 w-6 h-6 mr-2'>
                <img
                  ...
                  src='https://down-vn.img.susercontent.com/file/vn-11134004-7r98o-lnsmzxmz8k4tee_tn'
                  alt=''
                />
              </div>
              <div>HanNhat</div>
        ...
        <div className='grid items-end grid-cols-12 gap-4 mt-4'>
          ...
          <form action='' className='col-span-9'>
            <div className='flex p-1 bg-white rounded-sm'>
              <input
                type='text'
                placeholder='Tuần lễ sinh nhật -90%'
                ...
                <div className='relative bg-white border border-gray-200 rounded-sm shadow-md max-w-[400px] text-sm'>
                  <div className='p-2'>
                    ...
                    <div className='mt-5'>
                      <div className='flex mt-4'>
                        <div className='flex-shrink-0'>
                          <img
                            src='https://down-vn.img.susercontent.com/file/vn-11134201-7r98o-lwkbjzkeg34z5f.webp'
                            alt='anh'
                        ...
                        <div className='flex-grow ml-2 overflow-hidden'>
                          <div className='truncate'>
                            Nước tẩy trang và làm sạch sâu 3-in-1 L'Oreal Paris Micellar Water 400ml
                          </div>
                        </div>
                        <div className='flex-shrink-0 ml-2'>
                          <span className='text-orange'>₫179.000 </span>
                        </div>
                      </div>
                    </div>
                    <div className='mt-5'>
                    ...
                    <div className='flex items-center justify-between mt-6'>
                      <div className='text-xs text-gray-500 capliz'>Thêm vào giỏ hàng</div>
                      <button className='px-4 py-2 text-white capitalize rounded-sm hover:opacity-90 bg-orange'>
                        Xem giỏ hàng
                      </button>
                    </div>
                  </div>
